...
class ApiService {
    constructor() {
        ...
        this.baseURL = '/api'; // 使用相对路径，让 Netlify 重写规则生效
...
const api = new ApiService(); // 假设你的类叫 ApiService
window.api = api; 


// // 通过 window 定义全局变量
// const sharedApiInstance = new ApiService();
// window.api = sharedApiInstance;
// window.apiService = sharedApiInstance;

// // 创建全局API实例
// const apiService = new ApiService(); // 创建名为 apiService 的实例
// window.apiService = apiService;         // 将其暴露为全局变量 window.apiService